	...
	<div class="menu__inner">
		...
		<div class="menu__language animated d04 delay-06s fadeInLeft">
			<label class="menu__language-link">
				<input class="menu__language-input" type="radio" name='language' value='ua' v-model='changeLanguage'>
				<p class="menu__language-text menu__language-text--ua">{{ $t('menu.languages.ua') }}</p>
			</label>
			<label class="menu__language-link">
				<input class="menu__language-input" type="radio" name='language' value='ru' v-model='changeLanguage'>
				<p class="menu__language-text menu__language-text--ru">{{ $t('menu.languages.ru') }}</p>
			</label>
			<label class="menu__language-link">
				<input class="menu__language-input" type="radio" name='language' value='en' v-model='changeLanguage' checked>
