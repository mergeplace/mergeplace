...
define('GS_CONNECTOR_VERSION', '2.1');
define('GS_CONNECTOR_DB_VERSION', '2.1');
      ...
      <div class="wrap gs-form"> 
         ...
         <div class="gs-parts">
            ...
            <div class="gs-sidebar-block">
               ...
               <a target="_blank" href="https://wordpress.org/support/plugin/cf7-google-sheets-connector/reviews/" class="button button-primary gs-review-button" rel="noopener noreferrer">Write a review</a>
            </div>
         ...
         <div>
            <a href="https://www.gsheetconnector.com/" target="_blank"><img src="<?php echo GS_CONNECTOR_URL . 'assets/img/google-connector_banner.jpg'; ?>" class="gs-banner-img"></a>
         </div>
      </div>
      <?php
   }
